          ...
          >
            ...
            >
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block relative text-[rgba(58,58,58,0.67)] hover:underline hover:bg-[#ababab] hover:text-[rgba(58,58,58,1)] hover:rounded-sm transition-all duration-150"
              >
