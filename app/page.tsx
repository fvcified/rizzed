...
const navLinks = [
  ...
  { href: "https://rizzedpage.vercel.app/", label: "{ fvkid.site }" },
        ...
        <>
          <div
            ...
            style={{
              ...
              height:        "560px",
              zIndex:        9,
              opacity:       Math.min(1, sectionPhase * 1.8),
              background:    "radial-gradient(circle, rgba(255,255,255,0.07) 0%, rgba(255,255,255,0.025) 40%, transparent 70%)",
              borderRadius:  "50%",
              pointerEvents: "none",
            }}
          />
          ...
          >
            <div
              style={{
                opacity:      stagger(0),
                transform:    `translateY(${(1 - stagger(0)) * 18}px)`,
                textAlign:    "center",
                marginBottom: "12px",
                transition:   "none",
              }}
            ...
            <div
              style={{
                opacity:      stagger(1),
                transform:    `translateY(${(1 - stagger(1)) * 18}px)`,
                textAlign:    "center",
                marginBottom: "14px",
              }}
            >
            ...
            <div
              style={{
                opacity:      stagger(2),
                transform:    `translateY(${(1 - stagger(2)) * 18}px)`,
                textAlign:    "center",
                marginBottom: "40px",
              }}
            >
            ...
            <div
              style={{
                opacity:   stagger(3),
                transform: `translateY(${(1 - stagger(3)) * 18}px)`,
              }}
            >
              <div
